// Linear Regression Method Program V 1.1.0 / Programa del metodo de regresion lineal V 1.1.0
// Version Notes: User interface presentation changed.
// Warning added with instructions for the user, when points number been lower than 3.
#include "reglin.h"
#include "ui_reglin.h"
...
#include <QMessageBox> // Class for alow the use of Message Box.
...
void RegLin::cargar(){// This slot will save the data from table widget to a matrix, when the Load button been clicked.
    ...
    if(npuntos<3){// If the user introduced less than 3 points:
        ...
        // Shows a warning.
        QMessageBox::warning(this,"Advertencia","Debe introducir al menos tres puntos");
    }
